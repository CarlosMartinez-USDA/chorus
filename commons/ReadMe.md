...
name-tokens[1] = last name
name-tokens[2] = first name
name-tokens[3] using substring-after $name-tokens[2], able to gather the remaining parts of the authors given name.
<xsl:template match="authors">
       <xsl:for-each select="item">
           <xsl:variable name="name-tokens" select="tokenize(author, ' ')"/>
           <xsl:variable name="familyName" select="$name-tokens[1]"/>
...
Markdown 24301 bytes 1500 words 491 lines Ln 298, Col 27HTML 15801 characters 1428 words 428 paragraphs
